...
# -----------------------------------------------------------------
file_name = '/Users/vancefeng/Desktop/ords/AML/spotify_analysis_project/data/data_sampled_10000.csv'
...
# -----------------------------------------------------------------
# 3. 定义特征 (X) 和目标 (y) - 移除 Artist_Canon
# -----------------------------------------------------------------
print("\n--- 3. 定义特征与目标 ---")
...
# ⚠️ 移除 Artist_Canon，只保留 Continent 和 Nationality
categorical_features = ['Continent', 'Nationality']

X = df[numerical_features + categorical_features]
y = df['Pop_points_total']

print(f"✓ 已移除 'Artist_Canon' 特征")
...
with open(txt_filename, 'w', encoding='utf-8') as f:
    ...
    f.write(f"特征配置: 已移除 Artist_Canon\n\n")
